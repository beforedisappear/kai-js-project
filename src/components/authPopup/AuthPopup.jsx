...
// import { prevFormStep } from "./authPopupSlice.jsx";
...
//   const phoneNumber = useSelector((state) => state.authPopup.phoneNumber);
//   const newFormStep = useSelector((state) => state.authPopup.newFormStep);
